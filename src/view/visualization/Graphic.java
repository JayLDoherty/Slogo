...
public class Graphic {
	...
	private SimpleIntegerProperty imageIndex;
	
	protected Graphic(TurtleDisplay home, Image image, SimpleIntegerProperty index) {
		display = home;
	...
	protected SimpleIntegerProperty getIndex() {
		return imageIndex;
	}
